...
const SENTENCE_MODEL_EXPERIENCE: Readonly<Record<string, SentenceContract>> = {
  ...
  'packages/experimental/sub2api': { kind: 'indirect', reason: 'The opt-in provider delegates request rendering to dsh-llm-pi-ai.' },
  ...
  'packages/client/ui-brand-thunderuni': { kind: 'none', reason: 'Browser-side presentation occupants; registers nothing model-facing.' },
  ...
  'packages/client/ui-settings-sub2api': { kind: 'none', reason: 'Browser-side account settings projection; registers nothing model-facing.' },
