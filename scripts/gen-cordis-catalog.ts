...
export const TYPE_LINK_EXEMPTIONS: Readonly<Record<string, string>> = {
  ...
  Sub2apiStateView: 'Host account state projection is owned by packages/experimental/sub2api/README.md',
  Sub2apiProtocolProfile: 'Host deployment profile contract is owned by packages/experimental/sub2api/README.md',
  Sub2apiRegisterInput: 'Host registration input is owned by packages/experimental/sub2api/README.md',
  Sub2apiLoginInput: 'Host login input is owned by packages/experimental/sub2api/README.md',
  Sub2apiTwoFactorInput: 'Host second-factor input is owned by packages/experimental/sub2api/README.md',
