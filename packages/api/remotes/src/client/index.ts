...
import sub2apiRemote from '@deepseek-ai/dsh-experimental-sub2api/remote'
...
export type {} from '@deepseek-ai/dsh-experimental-sub2api/remote'
export type * from '@deepseek-ai/dsh-experimental-sub2api/client'
