...
/** Deployment-owned onboarding controls for the Models page. */
export interface Config {
  /** Register the internal-testing and official-provider first-run dialogs. */
  onboarding?: boolean
}

/** Validated Models-page configuration. */
